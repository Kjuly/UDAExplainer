...
```swift
dependencies: [
  .package(url: "https://github.com/Kjuly/UDAExplainer.git", .upToNextMajor(from: "1.0"))
]
```
...
To add a package dependency to your Xcode project, select **File > Add Package Dependency** and enter the URL: `https://github.com/Kjuly/UDAExplainer.git`.
...
3. Drag the built `UDAExplainer.xcframework` from `Carthage/Build` to the "Frameworks, Libraries, and Embedded Content" section of your Xcode project.
...
$ git submodule add https://github.com/Kjuly/UDAExplainer.git Libs/UDAExplainer
```

2. Open your project and add a reference to the source code folder: "UDAExplainer/UDAExplainer".
